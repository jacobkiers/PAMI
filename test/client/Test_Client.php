...
class Test_Client extends \PHPUnit_Framework_TestCase
{
    ...
    public function can_get_channel_variables()
    {
        ...
        $event = array(
            ...
            'ChanVariable(Local/0@pbx_dial_callroute_to_endpoint-00000008;2): var1=value1',
            'ChanVariable(Local/0@pbx_dial_callroute_to_endpoint-00000008;2): var2=value2',
        ...
        $this->assertEquals($varChan3, $event->getChannelVariables());
        $this->assertEquals($varChan3, $event->getChannelVariables('default'));
        $this->assertEquals(
            $varChan1,
        ...
        $this->assertEquals(
            $varChan2, $event->getChannelVariables('SIP/jw1034-00000010')
        );
    }
     ...
     * https://github.com/marcelog/PAMI/issues/85
     */
    public function can_get_channel_variables2()
    {
        global $mock_stream_socket_client;
        global $mock_stream_set_blocking;
        global $mockTime;
